...
実行方法:
  python scripts/step2_sync_scores.py              # 全件同期
  python scripts/step2_sync_scores.py --video-id VIDEO_ID  # 1件のみ
  python scripts/step2_sync_scores.py --dry-run     # 実行せず差分表示
